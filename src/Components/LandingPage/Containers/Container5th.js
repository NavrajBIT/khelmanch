...
export const Container5th = () => {
  ...
  const mainBoxStyle = matches ? { width: "360px", height: "261px", margin: "auto", marginTop: 10, positions: "absolute", mt: 10, boxShadow: "5px 5px 10px #ccc", ":hover:": { boxShadow: "20px 20px 40px #ccc" }, padding: "10px", background: "#ED842E", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center" } :{ width: "1028.92px", height: "647.79px", margin: "auto", marginTop: 10, positions: "absolute", mt: 10, boxShadow: "5px 5px 10px #ccc", ":hover:": { boxShadow: "20px 20px 40px #ccc" }, padding: "20px", background: "#ED842E", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center", borderRadius: 8, }
  const TypographyStyle = matches ? {marginTop:"30px",color: "white", fontFamily: "Inter", fontSize: "18px", fontWeight: "600", fontStyle: "normal", } : { color: "white", fontFamily: "Inter", fontSize: "42.34px", fontWeight: "600", fontStyle: "normal",}
  const ButtonStyle = matches ? {  marginTop:"80px",background: "black", color: "white", marginLeft: "15px", fontFamily: "Product Sans", fontWeight: "700", fontStyle: "normal", fontSize: "20px",  } : {  background: "white", color: "black", marginLeft: "15px", fontFamily: "Product Sans", fontWeight: "700", fontStyle: "normal", fontSize: "28.127px",  }
