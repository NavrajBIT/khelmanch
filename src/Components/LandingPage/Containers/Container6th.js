...
export const Container6th = () => {
  ...
  return (
    <div>
        ...
        {matches &&
          <Box >
            <Box position={"relative"} sx={{width:"359px",height:"300px",mt:5}}>
