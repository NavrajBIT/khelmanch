...
export const VideoCardHome = () => {
  ...
  return (
    <div>
            <Box sx={{ width: "500px", height: "450px", margin: "auto", mt: 2, padding: 0, marginLeft: 10, background: "#ED842E", boxShadow: "5px 5px 10px #ccc", ":hover:": { boxShadow: "20px 20px 40px #ccc" }, borderRadius: 8, }} >
