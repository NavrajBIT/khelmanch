  ...
  return (
    <div>
        ...
        <Box>
            ...
            alignItems={"center"}
            style={{borderRadius: "100%", border: "1px solid black", marginTop: "50px",
        ...
        >
            ...
            >
                ...
                <Box>
                    ...
                    <Select
                        ...
                        style={{width: "360px", height: "50px",border: "2px solid black", borderRadius: "10px", marginTop: "20px", }}
                        value={''}
                        label="Sort by"
                        onChange={(e) => {}}
                    >
            ...
            <textarea
                ...
                name="playerJourney"
                onChange={(e) => {}}
                value={inputs.playerJourney}
                type="text"
                placeholder="Player Journey"
                margin="normal"
              >
