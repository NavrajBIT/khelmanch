    ...
    return (
      <div className="editprofile">
        <div className="editprofileSection">
          ...
          <div className="editform">
            ...
            <select name="" id="">
              {playerData.map((player) => {
                return (
                  <option value="" key={player.name + player.sport}>
                    {player.name}
                  </option>
                );
              })}
          ...
          <button onClick={() => setIsAdding(false)}>Upload</button>
        </div>
      </div>
    );
  };
    ...
    <>
        <Box sx={{ width: "100%", height: "548px", margin: "auto", marginTop: 200, positions: "absolute", mt: 10, padding: "20px", background: "#FE8D3233", display: "flex", flexDirection: "row", justifyContent: "space-between", }} >
          ...
          <Box marginLeft={10} display="flex" flexDirection="column" >
            ...
            <Box marginTop={5} display={"flex"} flexDirection={"row"} >
              <Typography fontFamily={"Inter"} fontWeight="700" fontSize="25px" lineHeight={"30.26px"} color={"#000000"} >
                23 <br /> 
                Videos
              </Typography>
              <Typography fontFamily={"Inter"} fontWeight="700" fontSize="25px" lineHeight={"30.26px"} color={"#000000"} marginLeft={10} >
                5.2K <br /> 
                Followers
              </Typography>
              <Typography fontFamily={"Inter"} fontWeight="700" fontSize="25px" lineHeight={"30.26px"} color={"#000000"} marginLeft={10} >
